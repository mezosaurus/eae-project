...
public class TreeStateAxeManMinigameWrangleAxe : TreeState
{
    ...
    private const float ForearmStartAngle = 0f;
    private const float UpperArmEndAngle = 378.95144f;
    private const float LowerArmEndAngle = 268.2893f;
    ...
    private void Initialize()
    {
        ...
        timeElapsed = 0f;
        maxTime = MaxTime * GlobalGameStateManager.AxeManMinigameModifier1;
    ...
    public override void Update()
    {
        ...
        if (lsIn/* && rsIn*/)
        {
            ...
            Tree.ChangeState("AxeManMinigameGrabAxe", null);
